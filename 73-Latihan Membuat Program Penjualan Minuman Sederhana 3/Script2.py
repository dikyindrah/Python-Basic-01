...
def main():
    ...
    daftar_minuman = PrettyTable()
    daftar_minuman.field_names = ['No', 'Nama Minuman', 'Harga']
    daftar_minuman.align['No'] = 'c'
    daftar_minuman.align['Nama Minuman'] = 'l'
    daftar_minuman.align['Harga'] = 'r'
...
def tampil_keterangan_pesanan(minuman_user, nama_minuman, harga_minuman):
    keterangan_pesanan = PrettyTable()
    keterangan_pesanan.field_names = ['No', 'Nama Minuman', 'Harga']
    keterangan_pesanan.align['No'] = 'c'
    keterangan_pesanan.align['Nama Minuman'] = 'l'
    keterangan_pesanan.align['Harga'] = 'r'
